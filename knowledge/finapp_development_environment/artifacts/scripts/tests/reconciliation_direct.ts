...
const { ReconciliationService } = await import('../../../../../packages/server/src/services/reconciliation');
const { getAccountRef } = await import('../../../../../packages/server/src/firebase');

// REPLACE WITH VALID IDs
const USER_ID = 'REPLACE_WITH_USER_ID';
const ACCOUNT_ID = 'REPLACE_WITH_ACCOUNT_ID';
