...
export abstract class StatementImporter implements StatementImporterProto {
  ...
  async import(source: string): Promise<StatementProto> {
  ...
  protected async processTransaction(record: any): Promise<TransactionProto | null> {
    return null;
  }
}