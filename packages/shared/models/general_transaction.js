...
class GeneralTransaction extends Transaction {
    constructor(config) {
        super(config);

        // Core Data
        this.type = TransactionType.UNCATEGORIZED;
        this.category = null;
        this.name = null;
        this.merchant = null;
        ...
        this.credit = false;      // Flag to indicate if it's a credit transaction.
        this.cardMember = null;   // Privoder for credit card statements.
